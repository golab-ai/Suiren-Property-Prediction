...
class FileLogger:
    def __init__(self, is_master=False, is_rank0=False, output_dir=None, logger_name='training', time_name=None):
        # only call by master 
    ...
    def get_logger(self, output_dir, log_to_file):
        ...
        if output_dir and log_to_file:
            ...
            file_name_log = "debug_" + self.time_name + ".log"
            debuglog = logging.FileHandler(output_dir+file_name_log)
